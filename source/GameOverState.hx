...
class GameOverState extends FlxState
{
	...
	override public function create():Void
	{
		...
		add(tileMap);
		//addTexts();
		if(!MenuState.player.isWinner)
		{
			addText(0, 100,"Game Over", 80, 0x00);
			addText(0, 200,"sorry .. you are just not smart enough", 25, 0x00);
			addText(0, 400,"press 'G' or 'H' to try again", 16, 0x00);
		}
		else
		{
			addText(0, 100,"Game Over", 80, 0x00);
			addText(0, 200,"you are awesome ... and you should feel awesome", 25, 0x00);
			addText(0, 400,"press 'G' or 'H' to try again", 16, 0x00);
		}
	...
	override public function update():Void
	{
		...
		flixel.FlxG.switchState(new IntroState());
		super.update();
	}
}